...
const About = () => {
  ...
  return (
    <>
    <section className="h-screen md:h-screen md:flex md:flex-col md:justify-center md:items-center md:w-full md:mt-20" data-aos = "zoom-in">
        ...
        <div className="flex flex-col justify-center items-center            md:flex md:flex-row md:items-center md:gap-6 md:w-[1200px] md:relative md:bottom-14">
            <img  className="w-60 p-4  md:min-w-[450px]" src="\images\laptop.png" alt="laptop"  data-aos = "zoom-in"  />
