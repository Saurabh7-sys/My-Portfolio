...
const Content = () => {
  ...
  return (
    <>
      <main  className="mt-24 w-full max-w-full h-[650px]     md:flex md:items-center md:justify-between md:gap-8 md:max-w-[1500px] md:h-[70vh] md:mx-auto md:mt-5">
        <div className='px-5 md:min-w-[550px] md:ml-14'>
          ...
          <p className=' text-xl    md:w-72 md:mt-12 md:text-2xl'><span className='text-transparent bg-clip-text bg-gradient-to-r from from-white via-yellow-300 to-blue-300' >Transforming ideas into elegant web experiences with React</span></p>
        </div>
